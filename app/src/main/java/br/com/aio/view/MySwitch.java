...
/**
 * Created by elton on 05/10/2017.
 */
/*
...
public class MySwitch extends CompoundButton {
    ...
    // Enum for the "typefaceSwitch" XML parameter.
    ...
    public void setSwitchTextAppearance(Context context, int resid) {
        ...
        typefaceIndex = appearance.getInt(R.styleable.mySwitchTextAppearanceAttrib_typefaceSwitch, -1);
